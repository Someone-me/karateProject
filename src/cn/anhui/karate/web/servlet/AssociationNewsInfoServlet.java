...
@WebServlet("/AssociationNewsInfoServlet")
public class AssociationNewsInfoServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(idStr!=null && !idStr.equals("")) {
            ...
            List<NewsBean> bean= service.findSingleAssociationNewInfo(id);
