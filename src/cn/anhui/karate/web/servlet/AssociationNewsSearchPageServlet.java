...
@WebServlet("/AssociationNewsSearchPageServlet")
public class AssociationNewsSearchPageServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/associationNews.jsp").forward(request,response);
    }
