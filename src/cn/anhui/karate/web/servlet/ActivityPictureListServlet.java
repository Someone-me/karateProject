...
@WebServlet("/ActivityPictureListServlet")
public class ActivityPictureListServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/activityPictureList.jsp").forward(request,response);
    }
