            ...
            try {
                ...
                for (FileItem item : list) {
                    if (item.isFormField()) {
                        ...
                        //得到web应用中的某个目录的决定路径
                        String baseDir = "F:/文件/newKarate/karate/web/newsList/image";
                        ...
                        bean.setFilepath("newsList/image" + "/" + subDir + name);
                    }
                ...
                request.getRequestDispatcher("/newsSuccess.jsp").forward(request, response);
