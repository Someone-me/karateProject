...
<div class="content-wrapper" >
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="FileUploadServlet" enctype="multipart/form-data" method="post" class="col-lg-12 col-sm-12"style="margin-top: 30px" onsubmit="return checkFiles()">
