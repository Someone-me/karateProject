...
<div style="margin-bottom: 60px">
    ...
    <div class="container"style="border: 6px solid grey">
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12"style="margin-top: 10px"id="context">
               <%-- <pre id="context"></pre>--%>
            </div>
        </div>
    </div>
...
<script>
    ...
    function display() {
        $.post("${pageContext.request.contextPath}/MatchNewsInfoServlet",{},function (data) {
            var table_list = '';

            for (var i = 0; i < data.length; i++) {
                table_list +=
                    '<img src="'+ data[i].filepath +'"style="width: 80%;padding-left: 20px" >  ';
            }
            //alert(data);
