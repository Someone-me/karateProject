...
<head>
    ...
    <!-- JQVMap -->
&lt;%&ndash;    <link rel="stylesheet" href="plugins/jqvmap/jqvmap.min.css">&ndash;%&gt;
    <!-- Theme style -->
...
<div class="content-wrapper" >
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="NewsUploadServlet" enctype="multipart/form-data" method="post" class="col-lg-12 col-sm-12"style="margin-top: 30px" onsubmit="return checkFiles()">
                <table border="1px" style="margin: auto">
                    ...
                    <tr>
                        ...
                        <td class="col-lg-10 col-sm-10">
                            ...
                            <%--<input class="col-lg-1 col-sm-1" type="button" value="删除">--%>
    ...
    <center>
        <div style="margin-top: 10px">
            <a href="${pageContext.request.contextPath}/NewsListServlet">
...
<script src="plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
&lt;%&ndash;<script src="plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="plugins/jqvmap/maps/jquery.vmap.usa.js"></script>&ndash;%&gt;
<!-- jQuery Knob Chart -->
<script src="plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="plugins/moment/moment.min.js"></script>
