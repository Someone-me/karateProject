...
<div class="content-wrapper" >
    <div class="container">
        <form action="${pageContext.request.contextPath}/UpdatePictureInforServlet" method="post">
            <%--隐藏域提交id--%>
            <input type="hidden" name="id" value="${bean.id}">
            <div class="col-lg-12"style="margin-top: 100px">
                <label class="col-lg-1"style="padding: 0px;margin-left: 20px;text-align: center">描述</label>
                 <input type="text" class="col-lg-8 " id="information" name="information" value="${bean.information}">
            </div>
            <center>
                    <div>
