...
<div style="margin-bottom: 60px">
        ...
        <nav class="navbar navbar-inverse" style="background: #666666">
            <div class="container-fluid">
                ...
                <ul class="nav nav-pills" style="margin-top: 5px;">
                    ...
                    <li><a href="../announcement/association.jsp" class="navigation">关于协会</a></li>
                    <li><a href="../pressCenter/main.jsp" class="navigation">新闻中心</a></li>
                    <li><a href="#" class="navigation">通知公告</a></li>
                    <li><a href="#" class="navigation">图片</a></li>
                    <li><a href="#" class="navigation">视频</a></li>
                </ul>
            </div>
        </nav>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-2 col-sm-2"style="height: 400px;background: #F4F4F4">
                <ul class="nav nav-pills nav-stacked nav-pills-stacked-example"style="margin-top: 60px">
                    <li  class="active"><a href="../announcement/association.jsp">协会介绍</a></li>
                    <li ><a href="../announcement/organization.jsp">机构设置</a></li>
                    <li ><a href="../announcement/constitution.jsp">协会章程</a></li>
                    <li ><a href="../announcement/releation.jsp">联系我们</a></li>
                </ul>
            </div>
            <div class="col-lg-10 col-sm-10"style="padding: 20px">
                <div class="row col-lg-6 col-sm-10">
                    <nav class="navbar navbar-inverse" style="background: #F4F4F4;padding-left: 20px">
                        <ul class="nav nav-pills" style="margin-top: 5px;">
                            <li><a href="../announcement/organization.jsp">组织机构</a></li>
                            <li><a href="../announcement/lead.jsp">协会领导</a></li>
                            <li><a href="../announcement/department.jsp">部门介绍</a></li>
                        </ul>
                    </nav>
                </div>
