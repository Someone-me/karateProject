...
<div class="content-wrapper">
    <div class="row col-lg-12" style="padding: 0px">
        <form class="navbar-form navbar-left col-lg-9 col-sm-9" role="search" action="${pageContext.request.contextPath}/PictureListServlet" method="post">
    ...
    <table class="table table-bordered">
        ...
        <c:forEach items="${pageBean.list}" var="bean" varStatus="varSta">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/DeletePictureServlet?id=${bean.id}"><input type="button" value="删除"/></a>
<%--
                    <a href="${pageContext.request.contextPath}/UpdatePictureServlet?id=${bean.id}"><input type="button" value="修改"/></a>
--%>
                </td>
            </tr>
        </c:forEach>
    ...
    <div class="col-lg-12" >
        <nav aria-label="...">
            <ul class="pagination"style="float: right">
                ...
                <c:if test="${pageBean.currentPage!=1}">
                    <li>
                        <a href="${pageContext.request.contextPath}/PictureListServlet?currentPage=${pageBean.currentPage-1}"
                           aria-label="Previous">
                            <span aria-hidden="true">&laquo</span>
                        </a>
                    </li>
                ...
                <c:forEach begin="1" end="${pageBean.totalPage}" var="page">
                    ...
                    <c:if test="${pageBean.currentPage!=page}">
                        <li>
                            <a href="${pageContext.request.contextPath}/PictureListServlet?currentPage=${page}">${page}</a>
                        </li>
                    </c:if>
