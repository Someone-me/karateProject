...
<div class="content-wrapper" >
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="TrainUploadServlet" enctype="multipart/form-data" method="post" class="col-lg-12 col-sm-12"style="margin-top: 30px" onsubmit="return checkFiles()">
    ...
    <center>
        <div style="margin-top: 10px">
            <a href="${pageContext.request.contextPath}/TrainNewsListServlet">
