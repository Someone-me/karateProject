...
<div class="content-wrapper" >
    <div class="row col-lg-12" style="padding: 0px">
        <form class="navbar-form navbar-left col-lg-9 col-sm-9" role="search" action="${pageContext.request.contextPath}/MatchNewsListServlet" method="post">
    ...
    <table class="table table-bordered">
        ...
        <c:forEach items="${pageBean.list}" var="bean" varStatus="varSta">
            <tr>
                ...
                <td>${bean.filepath }</td>
                <td><a href="${pageContext.request.contextPath}/DeleteMatchNewsServlet?id=${bean.id}"><input type="button" value="删除"/></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    ...
    <nav aria-label="...">
        <ul class="pagination">
            ...
            <c:if test="${pageBean.currentPage!=1}">
                <li>
                    <a href="${pageContext.request.contextPath}/MatchNewsListServlet?currentPage=${pageBean.currentPage-1}"aria-label="Previous">
                        <span aria-hidden="true">&laquo</span>
                    </a>
                </li>
            </c:if>
            <c:forEach begin="1" end="${pageBean.totalPage}" var="page">
                ...
                <c:if test="${pageBean.currentPage!=page}">
                    <li>
                        <a href="${pageContext.request.contextPath}/MatchNewsListServlet?currentPage=${page}">${page}</a>
                    </li>
                </c:if>
            ...
            <c:if test="${pageBean.currentPage!=pageBean.totalPage}">
                <li> <a href="${pageContext.request.contextPath}/MatchNewsListServlet?currentPage=${pageBean.currentPage+1}"aria-label="Next">
                    <span aria-hidden="true">&laquo;</span>
                </a></li>
            </c:if>
        </ul>
