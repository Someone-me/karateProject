...
<div class="content-wrapper" >
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="PictureUploadServlet" enctype="multipart/form-data" method="post" class="col-lg-12 col-sm-12"style="margin-top: 30px" onsubmit="return checkFiles()">
                <table border="1px" style="margin: auto">
                    <tbody >
                    <tr>
                        <th class="col-lg-2 col-sm-2">选择上传的图片</th>
                        <td class="col-lg-10 col-sm-10">
                            <input class="col-lg-6 col-sm-6" type="file" name="name">
                            <input class="col-lg-3 col-sm-3" type="text" name="info">
    ...
    <center>
        <div style="margin-top: 10px">
            <a href="${pageContext.request.contextPath}/PictureListServlet">
...
<script>
    ...
    function addItem() {
        ...
        finput.setAttribute("class","col-lg-6 col-sm-6");
