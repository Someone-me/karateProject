...
<div class="content-wrapper" >
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="MatchUploadServlet" enctype="multipart/form-data" method="post" class="col-lg-12 col-sm-12"style="margin-top: 30px" onsubmit="return checkFiles()">
                <table border="1px" style="margin: auto">
                    <tbody >
                    <tr>
                        <th class="col-lg-2 col-sm-2">选择上传的文件</th>
                        <td class="col-lg-10 col-sm-10" style="padding: 0px">
                            <input class="col-lg-5 col-sm-5" type="file" name="name"style="padding: 0px">
                            <input class="col-lg-1 col-sm-1" type="button" value="标题">
                            <input class="col-lg-4 col-sm-4" type="text" name="title">
                            <%--<input class="col-lg-2 col-sm-2" type="button" value="删除" onclick="delItem(this)">--%>
                        </td>
                    </tr>
                    </tbody>
                   <%-- <tr>
    ...
    <center>
        <div style="margin-top: 10px">
            <a href="${pageContext.request.contextPath}/MatchNewsListServlet">
