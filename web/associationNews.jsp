        ...
        <div class="row tab">
            <div id="notice_tit" class="col-lg-2 col-sm-2 tab_list"
                ...
                <ul class="nav nav-pills nav-stacked nav-pills-stacked-example" style="margin-top: 100px">
                    <li class="news">
                        <a href="${pageContext.request.contextPath}/NewsCenterSearchPageServlet">新闻咨询</a>
                    </li>
                    <li class="association">
                        <a href="${pageContext.request.contextPath}/AssociationNewsSearchPageServlet">协会动态</a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-10 col-sm-10" style="">
                <div class="panel panel-default">
                    <div class="panel-heading" style="padding: 0px">
                        <form class="navbar-form navbar-left" role="search" action="${pageContext.request.contextPath}/AssociationNewsSearchPageServlet" method="post">
                    ...
                    <div class="item tab_con" id="" style="display: block;">
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${pageBean.list}" var="bean" varStatus="varSta">
                                <tr>
                                    <td><a href="${pageContext.request.contextPath}/ShowAssociationNewsServlet?id=${bean.id}">${bean.title}</a></td>
                        ...
                        <nav aria-label="...">
                            <ul class="pagination"style="float: right;">
                                ...
                                <c:if test="${pageBean.currentPage!=1}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/AssociationNewsSearchPageServlet?currentPage=${pageBean.currentPage-1}"aria-label="Previous">
                                            <span aria-hidden="true">&laquo</span>
                                        </a>
                                    </li>
                                </c:if>
                                <c:forEach begin="1" end="${pageBean.totalPage}" var="page">
                                    ...
                                    <c:if test="${pageBean.currentPage!=page}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/AssociationNewsSearchPageServlet?currentPage=${page}">${page}</a>
                                        </li>
                                    </c:if>
                                ...
                                <c:if test="${pageBean.currentPage!=pageBean.totalPage}">
                                    <li> <a href="${pageContext.request.contextPath}/AssociationNewsSearchPageServlet?currentPage=${pageBean.currentPage+1}"aria-label="Next">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a></li>
                                </c:if>
                            </ul>
                    ...
                    <%--<div class="item">
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${page.list}" var="bean" varStatus="varSta">
                                <tr>
                                    <td><a href="${pageContext.request.contextPath}/textServlet?id=${bean.id}">${bean.title}</a></td>
                                    <td>${bean.publishTime}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        ...
                        <nav aria-label="...">
                            <ul class="pagination"style="float: right;">
                                ...
                                <c:if test="${page.currentPage!=1}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/AssociationNewsPageServlet?currentPage=${pageBean.currentPage-1}"aria-label="Previous">
                                            <span aria-hidden="true">&laquo</span>
                                        </a>
                                    </li>
                                </c:if>
                                <c:forEach begin="1" end="${page.totalPage}" var="pag">

                                    &lt;%&ndash;判断当前页&ndash;%&gt;
                                    <c:if test="${page.currentPage==pag}">
                                        <li class="active">
                                    ...
                                    <c:if test="${page.currentPage!=pag}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/AssociationNewsPageServlet?currentPage=${pag}">${pag}</a>
                                        </li>
                                    </c:if>
                                ...
                                <c:if test="${page.currentPage!=page.totalPage}">
                                    <li> <a href="${pageContext.request.contextPath}/AssociationNewsPageServlet?currentPage=${pageBean.currentPage+1}"aria-label="Next">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a></li>
                                </c:if>
                            </ul>
...
--%>
    ...
    <%-- <a href="./pressCenter/associationNews.jsp"></a>--%>
</div>
