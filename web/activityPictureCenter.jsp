...
<div style="margin-bottom: 60px">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-4">
                    <a href="${pageContext.request.contextPath}/MatchPictureShowPageServlet">
                        <button type="button" class="btn btn-warning btn-lg" style="width: 100%">赛事图片</button>
                    </a>
                </div>
                <div class="col-lg-4">
                    <a href="${pageContext.request.contextPath}/ActivityPictureShowPageServlet">
                        <button type="button" class="btn btn-primary btn-lg" style="width: 100%">活动图片</button>
                    </a>
                </div>
            </div>
        </div>
                ...
                <c:if test="${varSta.count%5==0}">
                    ...
                    <div class="row col-lg-3 col-md-3" style="height: 290px;margin: 0px">
                        <div class="thumbnail" style="height: 240px">
                            <img src="${bean.filepath}" style="height: 186px">
    ...
    <div class="container">
        ...
        <nav aria-label="...">
            <ul class="pagination"style="float: right;">
                ...
                <c:if test="${pageBean.currentPage!=1}">
                    <li>
                        <a href="${pageContext.request.contextPath}/ActivityPictureShowPageServlet?currentPage=${pageBean.currentPage-1}"aria-label="Previous">
                            <span aria-hidden="true">&laquo</span>
                        </a>
                    </li>
                </c:if>
                <c:forEach begin="1" end="${pageBean.totalPage}" var="page">
                    ...
                    <c:if test="${pageBean.currentPage!=page}">
                        <li>
                            <a href="${pageContext.request.contextPath}/ActivityPictureShowPageServlet?currentPage=${page}">${page}</a>
                        </li>
                    </c:if>
                ...
                <c:if test="${pageBean.currentPage!=pageBean.totalPage}">
                    <li> <a href="${pageContext.request.contextPath}/ActivityPictureShowPageServlet?currentPage=${pageBean.currentPage+1}"aria-label="Next">
                        <span aria-hidden="true">&laquo;</span>
                    </a></li>
                </c:if>
            </ul>
...
<div class="container" style="background: #2D3237">
    <div class="row">
