...
<div class="content-wrapper" >
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="ActivityPictureUploadServlet" enctype="multipart/form-data" method="post" class="col-lg-12 col-sm-12"style="margin-top: 30px" onsubmit="return checkFiles()">
                <table border="1px" style="margin: auto">
                    <tbody >
                    <tr>
                        <th class="col-lg-2 col-sm-2">选择上传的图片</th>
                        <td class="col-lg-10 col-sm-10">
                            <input class="col-lg-5 col-sm-5" type="file" name="name" style="padding: 0px">
                            <input class="col-lg-1 col-sm-1" type="button" value="标题">
                            <input class="col-lg-3 col-sm-3" type="text" name="title">
    ...
    <center>
        <div style="margin-top: 10px">
            <a href="${pageContext.request.contextPath}/ActivityPictureListServlet">
...
<script>
    ...
    function addItem() {
        ...
        finput.setAttribute("class","col-lg-5 col-sm-5");
        finput.setAttribute("type","file");
        finput.setAttribute("name","name");
        finput.setAttribute("style","padding: 0px");
        //生成input
        var ainput=document.createElement("input");
        ainput.setAttribute("class","col-lg-1 col-sm-1");
        ainput.setAttribute("type","button");
        ainput.setAttribute("value","标题");
        //生成input
        var dinput=document.createElement("input");
        dinput.setAttribute("class","col-lg-3 col-sm-3");
        dinput.setAttribute("type","text");
        dinput.setAttribute("name","info"+(count+1));
        //生成input
