...
<div class="content-wrapper" >
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="VideoUploadServlet" enctype="multipart/form-data" method="post" class="col-lg-12 col-sm-12"style="margin-top: 30px" onsubmit="return checkFiles()">
                <table border="1px" style="margin: auto">
                    ...
                    <tr>
                        <td class="col-lg-2 col-sm-2">URL</td>
                        <td>
                            <div id="col-lg-10"></div>
                            <input type="text" name="url" value=""class="col-lg-12"style="padding: 0px"/>
                        </td>
                    </tr>
                    <%--<tr>
    ...
    <center>
        <div style="margin-top: 10px">
            <a href="${pageContext.request.contextPath}/VideoInfoListServlet">
